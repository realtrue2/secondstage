...
<div class="containerr">
	<header>
        ...
        <a  href="../">Расход</a>
        <a href="../plus">Доход</a>
        <a class="active" href="">Перемещение</a>
        <a href="../val">Обмен</a>
        </nav>
		</div>
		</header>
...
<div class="page-4">
	...
	<h2 class="reg-login-header">Шаблон перемещений</h2>
    <form  class="form" action="../../main.php" method="post">
        ...
        <div style="width: 360px;display: inline-block;"><input style="width: 360px;" placeholder="Сумма" class="input form-input required" name="sum" onkeyup="return proverka(this);" value="" required="" type="text"></div>
        ...
        <div style="display: inline-block;"><p>Из</p></div>
          ...
          <div style="display: inline-block;width: 197px;margin-left: 10px" class="size">
               ...
               <?php 
                    ...
                    echo ' <input style="width: 197px; type="text" name="bill1" value="'.$first.'" class="field required" readonly="readonly" required=""/>';
                    echo ' <ul class="list">';
           ...
           <div style="display: inline-block;width: 197px;margin-left: 10px" class="size">
               ...
               <?php 
                    ...
                    echo ' <input style="width: 197px; type="text" name="bill2" value="'.$first.'" class="field required" readonly="readonly" required=""/>';
                    echo ' <ul class="list">';
                    echo ' <div><a href="../../bill">НОВЫЙ СЧЕТ</a></div>';
                    foreach($bill as $value){
                        echo " <li>".$value["name"]."</li>";
        ...
        <input class="btn" style="margin-bottom: 15px; border: 1px solid #1c1c1c;" type="submit" value="Добавить шаблон" name="template-form-swap" /></span></form>
